...
- [Mapa de stakeholders, actores y perfiles](MAPA_STAKEHOLDERS_ACTORES_Y_PERFILES_v1.0.0.md).
- [Mapa de capacidades, alcance y priorización](MAPA_CAPACIDADES_ALCANCE_Y_PRIORIZACION_v1.0.0.md).
